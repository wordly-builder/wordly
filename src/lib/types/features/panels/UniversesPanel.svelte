...
<div class="flex flex-row h-full w-full">
	<LeftBar current="UNIVERSES" {navigateTo}/>

	<div class="flex flex-col h-full w-full p-4">
		<div class="flex flex-row items-center justify-between mb-6">
			<h1 class="text-2xl font-bold">Universes</h1>
		...
		<p class="text-gray-600 dark:text-gray-400 mb-6">Manage your universes here.</p>
	</div>
